// 📁 components/Features.tsx 파일 내용 (수정 및 에러 해결 완료)

import Link from 'next/link'; // ⭐️⭐️ 이 부분이 누락되어 에러가 발생했습니다. ⭐️⭐️
// import Image from 'next/image'; // Image 컴포넌트는 사용하지 않습니다.
    ...
    <section className="features-section">
      <div className="features-container">
        ...
        <div className="cta-section">
            ...
            <button className="btn btn-primary btn-large btn-cta-signup">
                무료 시작하기
            </button>
        </div>
      </div>
