...
const faqList = [
    ...
    },
    {
        id: 2,
        category: 'service',
        question: '어떤 학교의 정보를 볼 수 있나요?',
        answer: '현재 동양미래대학교, 한양대학교 등 주요 대학의 정보를 제공하고 있습니다. 학교 목록은 "학교 선택" 페이지에서 확인하실 수 있습니다.'
    },
    {
        id: 3,
        category: 'service',
        question: '챗봇이 답변을 못해요.',
        answer: '챗봇은 학습된 학칙 데이터 내에서만 답변할 수 있습니다. 질문을 좀 더 구체적으로 입력하거나, 해당 정보가 없는 경우일 수 있습니다.'
    },
    {
        id: 4,
        category: 'account',
        question: '비밀번호를 잊어버렸어요.',
        answer: '로그인 화면에서 "비밀번호 찾기" 버튼을 눌러주세요.'
    },
    {
        id: 5,
        category: 'privacy',
